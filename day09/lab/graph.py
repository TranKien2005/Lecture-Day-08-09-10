...
def supervisor_node(state: AgentState) -> AgentState:
    ...
    policy_keywords = ["hoàn tiền", "refund", "flash sale", "license", "cấp quyền", "access", "level 3", "admin access", "contractor"]
    retrieval_keywords = ["p1", "escalation", "sla", "ticket", "vpn", "remote", "mật khẩu", "đăng nhập"]
    ...
    if any(kw in task for kw in policy_keywords):
        ...
        route_reason = "task contains retrieval/SLA/helpdesk keyword"
